    ...
    while character == 'y' or character == 'Y':    
        ...
        if problem_int > 0:
            try:
                ...
                print("\nI haven't implemented a solution to this problem yet, sorry. Try pulling from this repository a few days later and maybe I'll have solved the problem by then. \nThanks for your patience.")
        else:
